...
Cypress.Commands.add('back2ThePast', function () {
    cy.api({
        method: 'DELETE',
        url: 'back2thepast/629ec0e4e78b2a0016d3a1bf',
        failOnStatusCode: false
    }).then(function (response) {
        expect(response.status).to.eql(200)
    })
...
//POST /characters - Requisção que testa o cadastro de personagem
...
//GET /characters - Requisção que testa a obtenção de personagens
